    ...
    return html.Div([
        dbc.Row(align="center", children=[
            ...
            dbc.Col(children=[
                ...
                html.H5(children=["For season 1 rankings, support, fixing submissions or to contribute join us at ", html.A("our discord", href="https://discord.gg/hBx8cCMRpd")], className="text-secondary", style=center_style),
            ]),
...
def load_current_elo_tables(json_data: List[dict], min_games: int):
    print('called problematic function', flush=True)
    ...
    print(results_history, flush=True)
    current_ratings = utils.prep_current_ratings_for_dash(
        tracker=tracker,
        results_history=results_history,
        min_games=min_games
    )
    print(current_ratings, flush=True)
    return (
