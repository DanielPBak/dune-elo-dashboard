    ...
    return html.Div([
        dbc.Row(align="center", children=[
            ...
            dbc.Col(children=[
                ...
                html.H5(children=["For name changes, fixing submissions, tech support or to volunteer, join the #dune-ranked-support channel on the TTSClub discord."], className="text-secondary", style=center_style),
            ]),
